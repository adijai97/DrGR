        ...
        <div className={styles.inner}>
          ...
          <FadeIn className={styles.testimonialSection}>
            ...
            <div className={styles.testimonialCard}>
              <button className={styles.arrowBtn} aria-label="Previous testimonial">
                <img src={imgVector} alt="" width={24} height={24} />
              </button>
              <div className={styles.testimonialContent}>
                <p className={styles.quoteText}>
                  &ldquo;Everything from healing, food, nutrition, and the mind is covered. Dr. Gauri also
                  taught how to plan things, implement the learnings, and sustain a new lifestyle.&rdquo;
                </p>
              ...
              <button className={styles.arrowBtn} aria-label="Next testimonial">
